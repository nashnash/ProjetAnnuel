...
<section align="center">
	...
	<form name="IMC" action="" class="form-horizontal" role="form">
		...
		<div class="form-group">
		 ...
		 <div class="col-sm-9">
		 <input type="text" name="poids" class="form-control"></input>
		 </div>
		</div>
		...
		<div class="col-sm-9">
			<input type="text" name="taille" class="form-control"></input></div>
		</div>
    	...
    	<div class="col-sm-9">
    		<input type="text" name="age" class="form-control"></input></div>
    	</div>
		<input type="reset" class="btn btn-primary" value="calculer IMC & Poids ideal" onclick="calcul_IMC()"/>
	</form>

		<br><h4 style='color:orange' class="color" id="return" ></h4>
